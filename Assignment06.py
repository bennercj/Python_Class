...
#   CBenner, 11/28/2018, Consolidated into Functions & Classes
...
objFileName = "C:\_PythonClass\Assignment06\Module06\ToDo.txt"
strData = ""
dicRow = {}
lstTable = []
...
class Operators(object):
    def LoadData(): #Define Load Data Function
...
while(True):
    ...
    if (strChoice.strip() == '1'):
        ...
        Operators.AddNewData()
        continue #to show the menu
    # Step 5
    # Remove a new item to the list/Table
    elif(strChoice == '3'):
        Operators.DeleteData()
        continue #to show the menu
    # Step 6
    # Save tasks to the ToDo.txt file
    elif(strChoice == '4'):
